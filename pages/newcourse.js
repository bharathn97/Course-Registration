...
const handleRemoveExam = (index) => {
  ...
  {
     e.preventDefault();
     console.log("The exams is"+exams);
...
const totalWeight = exams.reduce((sum, exam) => sum + exam.weightage, 0);
   ...
   if (!shouldUpdate) {
    ...
    const simplifiedPrerequisites = prerequisites.map(({ prerequisitesDegree, prerequisitesBranch, LectureSlots, PracticalSlots },index) => ({
     ...
     let data={ ...courseData, instructor: staffID , CreatedSlots: simplifiedPrerequisites,prerequisites:Prerequisites};
  ...
  <div class="border-b border-gray-900/10 pb-12">
    ...
    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
      <div class="sm:col-span-4">
        ...
        <span className="font-semibold text-red-500">Please Choose A New and Unique Code</span>
          <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
            <input type="text" name="CourseCode" id="CourseCode"  class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" value={courseData.CourseCode}
      ...
      <div class="sm:col-span-4">
        ...
        <div class="mt-2">
          <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
            <input type="text" name="CourseTitle" id="CourseTitle"  class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" value={courseData.CourseTitle}
                    onChange={handleInputChange}/>
          </div>
        </div>
      </div>
      <div class="mt-5 space-y-10">
        <div class="mt-2 space-y-1">
          ...
          <select
            ...
            onChange={handleCourseTypeChange} // Update this function accordingly
          >
...
<div class="mt-5 space-y-10">
  ...
  <div class="border-b border-gray-900/10 pb-12">
    <div class="mt-5 space-y-10">
      <div class="mt-2 space-y-1">
        <label htmlFor="courseCredits" class="block text-sm font-bold leading-6 text-gray-900">Course Credits</label>
        <select
          id="courseCredits"
          name="courseCredits"
